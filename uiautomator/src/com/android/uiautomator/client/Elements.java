...
//		UiObject el = new UiObject(sel);
		UiObject el = UiDevice.getInstance(InstrumentationRegistry.getInstrumentation()).findObject(sel);
	...
	public ArrayList<Element> getElements(UiSelector selector)
		...
		if (endsInstance) {
			...
			UiObject obj = UiDevice.getInstance(InstrumentationRegistry.getInstrumentation()).findObject(selector);
		...
		while (keep) {
			...
			obj = UiDevice.getInstance(InstrumentationRegistry.getInstrumentation()).findObject(tmp);
			counter++;
